				...
				<div class="flex flex-col flex-auto z-10 w-full">
					{#if $settings?.landingPageMode === 'chat' || createMessagesList(history.currentId).length > 0}
						...
						<div class=" pb-[1.6rem]">
							...
							/>
							<div style="position: absolute; left:80px; top: 50%; transform: translateY(-50%);" class="flex flex-col justify-center space-y-4 text-gray-500">
								<button 
								  class="bg-[#3d392f] hover:bg-[#4a463d] text-white font-bold py-2 px-4 rounded" 
